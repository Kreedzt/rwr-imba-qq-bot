    ...
    it.concurrent('query start match', () => {
        ...
        const MOCK_LOCAL_DATA: ITDollDataItem[] = [
            ...
            },
            {
                ...
                "modtileEffect1Time": "20%",
                "modEva": "35",
                "avatarMod": "https://www.gfwiki.org/images/e/ea/Icon_No.125_Mod.png",
                "modAcc": "35",
                "modRate": "140",
                "modAtk": "87",
                "modArmor": "0",
            ...
            },
            {
                ...
                "modEva": "68",
                "avatarMod": "https://www.gfwiki.org/images/8/86/Icon_No.94_Mod.png",
                "modAcc": "11",
                "modRate": "93",
                "modAtk": "28",
                "modArmor": "0",
            ...
            },
            {
                ...
                "tileEffect2": "回避",
                "tilesAffect": "冲锋枪",
                "obtainMethod": "可通过常规制造获取/可通过重型制造获取/可在通常战役中救援获得",
