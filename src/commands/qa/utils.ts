...
const genGLMMessages = (
    ...
    return [
        {
            role: 'system',
            content: `作为一名智能客服，请你记住以下JSON字符串中的知识库内容，JSON字符串格式为JSON数组，每项为JSON对象，对象中键q对应的值为问题，键a对应的值为答案，并根据知识库内容用简洁和专业的来回答用户问题。如果无法从中得到答案，请说 “根据已知信息无法回答该问题” 或 “没有提供足够的相关信息”，不允许在答案中添加编造成分，答案请使用中文。 `,
        },
        {
            role: 'user',
