...
export class ServersCanvas extends BaseCanvas {
    ...
    measureRender() {
        ...
        // 加上两端间距
        const titleWidth = context.measureText(this.totalTitle).width + 20;
        this.renderList(context);
        const listWidth = this.maxRectWidth + 30;
        this.renderFooter(context);
        const footerWidth = context.measureText(this.totalFooter).width + 20;
